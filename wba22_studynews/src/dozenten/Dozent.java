 ...
 *                   &lt;element name="schwerpunkte" type="{http://www.w3.org/2001/XMLSchema}anyType" minOccurs="0"/>
...
public class Dozent {
    ...
    @XmlElement(required = true)
    protected Dozent.Adresse adresse;
    @XmlElement(required = true)
    protected Dozent.Lehre lehre;
    @XmlElement(required = true)
    protected Dozent.Newsticker newsticker;
    @XmlElement(required = true)
    protected Dozent.Abonnenten abonnenten;
     ...
     *     
     */
    public Dozent.Adresse getAdresse() {
        return adresse;
    }
     ...
     *     
     */
    public void setAdresse(Dozent.Adresse value) {
        this.adresse = value;
    }
     ...
     *     
     */
    public void setLehre(Dozent.Lehre value) {
        this.lehre = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link Dozent.Newsticker }
     *     
     */
    public Dozent.Newsticker getNewsticker() {
        return newsticker;
    }
     ...
     *     
     */
    public void setNewsticker(Dozent.Newsticker value) {
     ...
     * @return
     *     possible object is
     *     {@link Dozent.Abonnenten }
     *     
     */
    public Dozent.Abonnenten getAbonnenten() {
        return abonnenten;
    }
     ...
     *     
     */
    public void setAbonnenten(Dozent.Abonnenten value) {
    ...
    public static class Abonnenten {
        ...
        protected java.util.List<Dozent.Abonnenten.Abonnent> abonnent;
         ...
         * {@link Dozent.Abonnenten.Abonnent }
         * 
         * 
         */
        public java.util.List<Dozent.Abonnenten.Abonnent> getAbonnent() {
            if (abonnent == null) {
                abonnent = new ArrayList<Dozent.Abonnenten.Abonnent>();
            }
    ...
    public static class Adresse {
        ...
        @XmlElement(required = true)
        protected Dozent.Adresse.Raum raum;
        @XmlElement(required = true)
        protected Dozent.Adresse.Tel tel;
        @XmlElement(required = true)
        protected Dozent.Adresse.Email email;
        @XmlAttribute
        protected String titel;
         ...
         * @return
         *     possible object is
         *     {@link Dozent.Adresse.Raum }
         *     
         */
        public Dozent.Adresse.Raum getRaum() {
            return raum;
        }
         ...
         *     
         */
        public void setRaum(Dozent.Adresse.Raum value) {
            this.raum = value;
        }
         ...
         * @return
         *     possible object is
         *     {@link Dozent.Adresse.Tel }
         *     
         */
        public Dozent.Adresse.Tel getTel() {
            return tel;
        }
         ...
         *     
         */
        public void setTel(Dozent.Adresse.Tel value) {
            this.tel = value;
        }
         ...
         * @return
         *     possible object is
         *     {@link Dozent.Adresse.Email }
         *     
         */
        public Dozent.Adresse.Email getEmail() {
            return email;
        }
         ...
         *     
         */
        public void setEmail(Dozent.Adresse.Email value) {
            this.email = value;
        }
        ...
        public static class Tel {
            ...
            @XmlElement(required = true)
            protected java.util.List<Dozent.Adresse.Tel.Nummer> nummer;
             ...
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link Dozent.Adresse.Tel.Nummer }
             * 
             * 
             */
            public java.util.List<Dozent.Adresse.Tel.Nummer> getNummer() {
                if (nummer == null) {
                    nummer = new ArrayList<Dozent.Adresse.Tel.Nummer>();
                }
                return this.nummer;
            }
    ...
    public static class Lehre {
        ...
        @XmlElement(required = true)
        protected Dozent.Lehre.Veranstaltungen veranstaltungen;
         ...
         * @return
         *     possible object is
         *     {@link Dozent.Lehre.Veranstaltungen }
         *     
         */
        public Dozent.Lehre.Veranstaltungen getVeranstaltungen() {
         ...
         *     
         */
        public void setVeranstaltungen(Dozent.Lehre.Veranstaltungen value) {
        ...
        public static class Veranstaltungen {
            ...
            @XmlElement(required = true)
            protected java.util.List<Dozent.Lehre.Veranstaltungen.List> list;
            @XmlAttribute
            protected String titel;
             ...
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link Dozent.Lehre.Veranstaltungen.List }
             * 
             * 
             */
            public java.util.List<Dozent.Lehre.Veranstaltungen.List> getList() {
                if (list == null) {
                    list = new ArrayList<Dozent.Lehre.Veranstaltungen.List>();
                }
                return this.list;
            }
    ...
    public static class Newsticker {
        ...
        protected java.util.List<Dozent.Newsticker.Eintrag> eintrag;
        @XmlAttribute
        protected String titel;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link Dozent.Newsticker.Eintrag }
         * 
         * 
         */
        public java.util.List<Dozent.Newsticker.Eintrag> getEintrag() {
            if (eintrag == null) {
                eintrag = new ArrayList<Dozent.Newsticker.Eintrag>();
            }
            return this.eintrag;
        }
